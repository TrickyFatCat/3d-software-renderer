...
load_mesh_from_obj :: proc{load_mesh_from_obj_data, load_mesh_from_obj_file}
    ...
    for line in strings.split_lines_iterator(file_data) {
        ...
        switch data_type {
            case "v ":
                ...
                vertex: math.Vec3 = {x = float_arr[0], y = float_arr[1], z = float_arr[2]}
            ...
            case "f ":
                ...
                face: Face = {a = int_arr[0], b = int_arr[1], c = int_arr[2]}
